...
package com.example.ekta.appgw;
...
public class ImageListFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
       if (ImageListFragment.this.getArguments().getInt("type") == 1) {
        ...
        String[] items=null;
       if (ImageListFragment.this.getArguments().getInt("type") == 1){
            items = com.example.ekta.appgw.ImageUrlUtils.getOffersUrls();
        }else if (ImageListFragment.this.getArguments().getInt("type") == 2){
            items = com.example.ekta.appgw.ImageUrlUtils.getElectronicsUrls();
        }else if (ImageListFragment.this.getArguments().getInt("type") == 3){
            items = com.example.ekta.appgw.ImageUrlUtils.getLifeStyleUrls();
        }else if (ImageListFragment.this.getArguments().getInt("type") == 4){
            items = com.example.ekta.appgw.ImageUrlUtils.getHomeApplianceUrls();
        }else if (ImageListFragment.this.getArguments().getInt("type") == 5){
            items = com.example.ekta.appgw.ImageUrlUtils.getBooksUrls();
        }else {
            items = com.example.ekta.appgw.ImageUrlUtils.getImageUrls();
        }
        StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(layoutManager);
